 ...
 const stories = [
  {
    ...
    date: "June 2, 2025",
    image: "https://res.cloudinary.com/dqdvr35aj/image/upload/v1755777282/Success_Stories_3_qjlgls.jpg",
    content: `
  ...
  },
  {
    ...
    title: "Panémorfos Jewelry Achieves 34% Increase in Net Profit with Profit First",
    author: "Founder, Panémorfos Jewelry",
    date: "June 9, 2025",
    image: "https://res.cloudinary.com/dqdvr35aj/image/upload/v1755777282/Success_Stories_2_grscxu.jpg",
    content: `
  ...
  },
  {
    id: 3,
    category: "Client Success Story",
    title: "Silly Cartel Achieves 31% Increase in Net Profit with Profit First",
    author: "Founder, Silly Cartel",
    date: "June 16, 2025",
    image: "https://res.cloudinary.com/dqdvr35aj/image/upload/v1755777282/Success_Stories_1_xg1ff3.jpg",
    content: `
  ...
  return (
    <>
    <section id="CUSTOMERSTORIES" className="py-32 px-12 md:px-12 text-white overflow-x-hidden bg-[#101218]">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-center text-white max-w-2xl mx-auto mb-10 px-2 text-sm sm:text-base">
          Read how our customers achieved profitability and growth with Profit First.
        </p>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-80 z-50 flex items-center justify-center px-4">
          <div className="bg-[#1e1e1e] w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-lg shadow-lg relative p-6 text-white">
            ...
            <div className="mt-6">
              ...
              />
              <h3 className="text-sm text-green-500 mt-4">{selectedStory.category}</h3>
